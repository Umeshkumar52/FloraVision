...
import Roonnie from "../assets/unsplash_3TLl_97HNJo.png";
      ...
      <div className="flex flex-col md:flex-row px-20 justify-center md:justify-between">
        <div className="flex md:items-start  items-center mt-8 flex-col gap-[6rem]">
          <div className="space-y-2">
            <h1 className="md:text-8xl text-6xl font-semibold">Earth’s Exhale</h1>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                {Array.from({ length: 4 }, (_, i) => i + 1).map(
                  (item, index) => (
                    <img src={star1} key={index} className="size-4" />
                  )
                )}
                <img src={star5} className="size-4" />
              </div>
              </div>
            </div>
            <p>
